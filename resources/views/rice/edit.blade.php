...
@section('page-title', 'Rice Menu → Edit Item')
...
<div class="row justify-content-center">
    <div class="col-lg-7">
        <div class="d-flex align-items-center gap-2 mb-3">
            ...
            <h5 class="mb-0 fw-semibold">Edit: {{ $rice->name }}</h5>
        </div>

        <div class="card">
            <div class="card-body p-4">
                <form action="{{ route('rice.update', $rice) }}" method="POST">
                    @csrf @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="price_per_kg" step="0.01" min="0"
                                       ...
                                       value="{{ old('price_per_kg', $rice->price_per_kg) }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" name="stock_quantity" step="0.01" min="0"
                                       ...
                                       value="{{ old('stock_quantity', $rice->stock_quantity) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" rows="3"
                                  class="form-control @error('description') is-invalid @enderror">{{ old('description', $rice->description) }}</textarea>
                        @error('description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-brand px-4">
                            <i class="bi bi-floppy me-1"></i> Update Rice Item
                        </button>
